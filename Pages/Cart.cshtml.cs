...
namespace Book_store.Pages
{
    ...
    public class CartModel : PageModel
    {
        ...
        private Dictionary<String, int> getBookDictionary()
        {
            ...
            //read shopping cart from cookie
        ...
        public void OnGet()
        {
            ...
            if (action != null && id != null && bookDictionary.ContainsKey(id))
            {
                ...
                // - to set the shopping cart size using the update cookie
        ...
        public void OnPost()
        {
            ...
            //Delete the cookie "shopping_cart" from browser after saving the data in database.
